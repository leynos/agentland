.PHONY: help all clean test build release lint fmt check-fmt markdownlint nixie graphs check-graphs manifest-check assets-check spelling spelling-config spelling-phrase-check spelling-helper-test
